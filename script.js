...
const studentDB = {
    ...
    "Y24120060": { name: "AARYA GOANTIYA", course: "B.A.", books: [0, 5] }, "Y24120061": { name: "ANIYA PARTE", course: "B.A.", books: [0, 6] },
    "Y24120062": { name: "SATYAM SEN", course: "B.A.", books: [0, 7] }, "Y24120087": { name: "AGRATI AGRAWAL", course: "B.A.", books: [1, 2] },
    "Y24120088": { name: "SHUBHAM CHOUBEY", course: "B.A.", books: [1, 3] }, "Y24120116": { name: "HARSH LODHI", course: "B.A.", books: [1, 4] },
    "Y24120127": { name: "RITIK RAJ", course: "B.A.", books: [1, 5] }, "Y24120129": { name: "BOBI RAJA", course: "B.A.", books: [1, 6] },
    ...
    "Y24120246": { name: "NANCY PANDEY", course: "B.A.", books: [5, 7] }, "Y24120260": { name: "AYUSH AHIRWAR", course: "B.A.", books: [6, 7] },
    "Y24120261": { name: "NEERAJ YADAV", course: "B.A.", books: [0, 1] }, "Y24120280": { name: "ADITYA VINODIYA", course: "B.A.", books: [0, 2] },
    "Y24120282": { name: "RIMJHIM SONI", course: "B.A.", books: [0, 3] }, "Y24120283": { name: "SHIVANSHU MISHRA", course: "B.A.", books: [0, 4] },
    "Y24120293": { name: "ABHI YADAV", course: "B.A.", books: [0, 5] }, "Y24120294": { name: "ADITYA TIWARI", course: "B.A.", books: [0, 6] },
    ...
    "Y24120339": { name: "ASHISH KUMAR", course: "B.A.", books: [1, 7] }, "Y24120355": { name: "KULDEEP YADAV", course: "B.A.", books: [2, 3] },
    "Y24120356": { name: "NEETESH DANGI", course: "B.A.", books: [2, 4] }, "Y24120393": { name: "NANCY JAIN", course: "B.A.", books: [2, 5] },
    "Y24120395": { name: "MEENAKSHI SEN", course: "B.A.", books: [2, 6] }, "Y24120449": { name: "HARSH YADAV", course: "B.A.", books: [2, 7] },
    ...
    "Y24120618": { name: "ANSHIKA SIROTHIYA", course: "B.A.", books: [0, 3] }, "Y24120621": { name: "APRAJITA PATHAK", course: "B.A.", books: [0, 4] },
    "Y24120634": { name: "PUNEET SEN", course: "B.A.", books: [0, 5] }, "Y24120640": { name: "PRINCI JAIN", course: "B.A.", books: [0, 6] },
    "Y24120641": { name: "VIVEK AHIRWAR", course: "B.A.", books: [0, 7] }, "Y24120646": { name: "ANJLEE YADAV", course: "B.A.", books: [1, 2] },
    "Y24120647": { name: "APOORVA THAKUR", course: "B.A.", books: [1, 3] }, "Y24120657": { name: "AMAN KUMAR MARAVI", course: "B.A.", books: [1, 4] },
    "Y24120659": { name: "SHIVANSH VISHWAKARMA", course: "B.A.", books: [1, 5] }, "Y24120661": { name: "SIMRAN BEE", course: "B.A.", books: [1, 6] },
    "Y24120664": { name: "HARSH SEN", course: "B.A.", books: [1, 7] }, "Y24120665": { name: "PRATEEK NEGI", course: "B.A.", books: [2, 3] },
    "Y24120678": { name: "JIYA DUBEY", course: "B.A.", books: [2, 4] }, "Y24120691": { name: "KHUSHBOO AHIRWAR", course: "B.A.", books: [2, 5] },
    "Y24120692": { name: "JAYANT SEN", course: "B.A.", books: [2, 6] }, "Y24120697": { name: "JIGYASHA SHARMA", course: "B.A.", books: [2, 7] },
    "Y24130025": { name: "RAKSHA SINGH", course: "B.A.", books: [3, 4] }, "Y24130066": { name: "AASHIYA RANGREJ", course: "B.A.", books: [3, 5] },
    ...
    "Y24105001": { name: "Aashutosh Singh Dahiya", course: "B.Sc.", books: [2, 7] }, "Y24105002": { name: "Aastha Tiwari", course: "B.Sc.", books: [3, 4] },
    ...
    "Y24105015": { name: "Kumar Gaurav", course: "B.Sc.", books: [0, 4] }, "Y24105016": { name: "Madhvi Sharma", course: "B.Sc.", books: [0, 5] },
    ...
    "Y24105027": { name: "Sumit Raman Ray", course: "B.Sc.", books: [2, 5] }, "Y24105028": { name: "Namita Kumari", course: "B.Sc.", books: [2, 6] },
    ...
    "Y24107007": { name: "Janvi Kumari", course: "B.Sc.", books: [0, 2] }, "Y24107008": { name: "Likha Manyo", course: "B.Sc.", books: [0, 3] },
    ...
    "Y24107017": { name: "Sanidhya Tiwari", course: "B.Sc.", books: [1, 6] }, "Y24107018": { name: "Shailja Diwedi", course: "B.Sc.", books: [1, 7] },
